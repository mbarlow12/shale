  ...
  module Schema
    class XMLGenerator
      class Schema
        ...
        #
        # @param [Fido::Schema::XMLGenerator::Import,
        #         Fido::Schema::XMLGenerator::Element,
        #         Fido::Schema::XMLGenerator::Attribute,
        #         Fido::Schema::XMLGenerator::ComplesType] child
        #
        # @api private
        def add_child(child)
          @children << child
        ...
        #
        # @return [Fido::Adapter::REXML::Document,
        #          Fido::Adapter::Nokogiri::Document,
        #          Fido::Adapter::Ox::Document]
        #
        # @api private
        def as_xml
