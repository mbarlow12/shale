...
module Fido
  module Schema
    ...
    class XMLCompiler
      ...
      # Generate Fido models from XML Schema and return them as a Ruby Array of objects
      #
      ...
      # Generate Fido models from XML Schema
      #
      # @param [Array<String>] schemas
      # @param [Hash<String, String>, nil] namespace_mapping
      #
      ...
      #
      # @example
      #   Fido::Schema::XMLCompiler.new.to_models([schema1, schema2])
      #
      # @api public
      ...
      #
      # @param [Fido::Adapter::<Adapter>::Node] node
      # @param [String] name
      #
      # @return [true false]
      #
      ...
      # @param [Fido::Adapter::<Adapter>::Node] node
      #
      # @yieldparam [Fido::Adapter::<Adapter>::Node]
      #
      # @api private
      ...
      # @param [Fido::Adapter::<Adapter>::Node] node
      #
      # @return [Fido::Adapter::<Adapter>::Node, nil]
      #
      # @api private
      def get_schema(node)
        el = node
      ...
      #
      # @param [Fido::Adapter::<Adapter>::Node] schema
      #
      # @api private
      ...
      # @param [Fido::Adapter::<Adapter>::Node] node
      #
      # @return [Fido::Schema::Compiler::<any>]
      #
      # @api private
      def infer_type(node)
        namespaces = get_namespaces(get_schema(node))
      ...
      # @param [Fido::Adapter::<Adapter>::Node] node
      #
      # @return [Array<Fido::Adapter::<Adapter>::Node>]
      #
      # @api private
      ...
      #
      # @param [Fido::Schema::Compiler::XMLComplex] complex_type
      # @param [Fido::Adapter::<Adapter>::Node] node
      # @param [Symbol] mode
      #
      # @api private
      ...
      # @param [Fido::Adapter::<Adapter>::Node] schema
      #
      # @return [Fido::Adapter::<Adapter>::Node]
      #
      # @api private
      ...
      #
      # @param [Fido::Schema::Compiler::<any>] type
      #
      # @api private
