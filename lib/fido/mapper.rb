...
module Fido
  ...
  #     attribute :state, Fido::Type::Integer
  ...
  class Mapper < Type::Complex
    ...
    class << self
      ...
      # @param [Fido::Type::Value] type Type of the attribute
      ...
      #     attribute :first_name, Fido::Type::String
      #     attribute :last_name, Fido::Type::String
      #     attribute :age, Fido::Type::Integer, default: -> { 1 }
